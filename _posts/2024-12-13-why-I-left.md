...
{% include figure.liquid path="assets/img/phd.png" class="img-fluid rounded mx-auto d-block" max-width="600px" sizes="(min-width: 768px) 600px, 95vw" alt="Liv d'Aliberti before starting a Ph.D." %}
